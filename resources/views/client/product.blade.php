		...
		<div class="row">
			<div class="col-md-3 text-center">
				<div class="product-entry">
					<div class="product-img" style="background-image: url(assets/client/images/quan-kaki-xanh-den-qk171-9771.jpg);">
						<div class="cart">
							<p>
								...
								<span><a href="san-pham/3"><i class="icon-eye"></i></a></span>
					...
					<div class="desc">
						<h3><a href="san-pham/3">Quần kaki xanh đen</a></h3>
			...
			<div class="col-md-3 text-center">
				<div class="product-entry">
					...
					<div class="desc">
						<h3><a href="san-pham/3">Áo trắng kẻ vằn</a></h3>
						<p class="price"><span>3.000.000 đ</span></p>
					</div>
				</div>
			</div>
			<div class="col-md-3 text-center">
				<div class="product-entry">
					...
					<div class="desc">
						<h3><a href="san-pham/3">Áo nữ trắng bạch</a></h3>
						<p class="price"><span>3.000.000 đ</span></p>
					</div>
				</div>
			</div>
			<div class="col-md-3 text-center">
				<div class="product-entry">
					...
					<div class="desc">
						<h3><a href="san-pham/3">Áo sơ mi có cổ kẻ ô xám</a></h3>
						<p class="price"><span>3.000.000 đ</span></p>
					</div>
				</div>
			</div>
